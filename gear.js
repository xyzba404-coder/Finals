    ...
    mask:{
        ...
        helmet:{
            ...
            applyStats:function(stats,player){
                ...
                stats.redPollen*=15
                stats.pollenFrombees*=50
                stats.jumpPower*=2
                stats.redBeeAbilityRate*=55
                stats.blueBeeAbilityRate*=55
                stats.whiteBeeAbilityRate*=55
                stats.defense+=555
                stats.convertRate*=15
                stats.beeEnergy*=1.15
                stats.lootLuck*=75

            },
            desc:'A playful hat that keeps the sun out of your eyes.<br><br>op ASF CAUSE OF BSS MOD BY FELIX',
            cost:['1 honey','-1500000 gumdrops','-1000000 pineapple','-100000 moonCharm','-400 starTreat','-500 diamondEgg','-400 mythicEgg'],
...
,
        ...
        gummyMask:{
            ...
            applyStats:function(stats,player){
                ...
                player.addEffect('ignitePassive')
                stats.instantFlameConversion=window.applyPercentage(stats.instantFlameConversion,0.5)
                stats.flamePollen*=50
                 stats.bubblePollen*=50
            ...
            cost:['1 honey','1 glue','1 enzymes','1 oil','1 glitter'],
        },
    ...
    belt:{
        ...
        petalBelt:{
            ...
            cost:['1 honey','-15000000 starJelly','-5000000 glitter','-75000000 glue','-30 spiritPetal'],
        }
    },
    ...
    backpack:{
        ...
        pouch:{
            ...
            applyStats:function(stats,player){
                ...
                stats.whitePollen*=10.25
                stats.whitePollen*=10.25
                stats.redPollen*=10.25
                stats.bluePollen*=10.25
                stats.whiteBeeAttack+=20
                stats.redBeeAttack+=20
                stats.blueBeeAttack+=20
                stats.defense+=50.1
                stats.honeyAtHive*=100.1
        ...
        coconutCanister:{
            ...
            cost:['1 honey','1 tropicalDrink','11 redExtract','11 blueExtract'],
        }
    },
    ...
    boots:{
        ...
        gummyBoots:{
            ...
            applyStats:function(stats,player){
                ...
                stats.movementCollection+=1500
                stats.walkSpeed*=2.2
                stats.jumpPower*=2.4
                stats.pollenFromCoconuts*=5
                stats.goo*=15.25
                stats.beeSpeed*=55.3
                stats.honeyFromTokens*=15.25
                stats.redPollen*=15.1
                stats.bluePollen*=15.1
                stats.whitePollen*=15.1
                stats.beeAttack*=15.1
                stats.convertRateAtHive*=25
            ...
            cost:['1 honey','1 glue','1 glitter','1 redExtract','1 blueExtract'],
        },
    ...
    leftGuard:{
        ...
        lookerGuard:{
            ...
            applyStats:function(stats,player){
                ...
                stats.convertRate*=10.4
                stats.redPollen*=10.35
                stats.capacity+=3000000000
                stats.instantRedConversion=window.applyPercentage(stats.instantRedConversion,0.2)
                stats.redBombPollen*=10.5
                stats.redBeeAttack+=30
                stats.whiteBeeAttack+=20

    ...
    belt:{
        ...
        beltPocket:{
            ...
            applyStats:function(stats,player){
                  ...
                  stats.capacity+=30000000
                stats.capacityMultiplier*=20
                stats.lootLuck*=20
                stats.convertRate*=10.8
                stats.honeyFromTokens*=10.5
                stats.whiteBeeAttack+=20
                stats.whiteBombPollen*=10.5
                stats.beeEnergy*=10.25
    ...
    boots:{
        ...
        gummyBoots:{
            ...
            applyStats:function(stats,player){
                ...
                stats.movementCollection+=150
                stats.walkSpeed*=3.2
                stats.jumpPower*=1.4
                stats.pollenFromCoconuts*=20
                stats.goo*=10.25
                stats.beeSpeed*=2
                stats.honeyFromTokens*=10.25
                stats.redPollen*=10.1
                stats.bluePollen*=10.1
                stats.whitePollen*=10.1
                stats.beeAttack*=10.1
                stats.convertRateAtHive*=20
            ...
            cost:['1 honey','50 glue','50 glitter','50 redExtract','50 blueExtract'],
        },
    ...
    rightGuard:{
        ...
        hastyGuard:{
            ...
            applyStats:function(stats,player){
                ...
                stats.instantBlueConversion=window.applyPercentage(stats.instantBlueConversion,0.2)
                stats.blueBombPollen*=10.5
                stats.blueBeeAttack+=30
                stats.whiteBeeAttack+=20
                stats.criticalPower+=10
            ...
            cost:['-100000 honey','-1 moonCharm','-1 windyBeeEgg','-1 gummyBeeEgg'],
        },
